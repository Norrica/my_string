...
START_TEST(test_memchr) {
    int i = 0;
    ck_assert_ptr_eq(memchr(values[i].str1, values[i].c, values[i].n),
                     s21_memchr(values[i].str1, values[i].c, values[i].n));
    i++;
    ck_assert_ptr_eq(memchr(values[i].str1, values[i].c, values[i].n),
                     s21_memchr(values[i].str1, values[i].c, values[i].n));
    i++;
...
START_TEST(test_memcmp) {
    int i = 0;
    ck_assert_int_eq(memcmp(values[i].str1, values[i].str2, values[i].n),
...
START_TEST(test_memcpy) {
    ...
    ck_assert_str_eq(memcpy(temp1, values[i].str2, values[i].n),
                     s21_memcpy(temp2, values[i].str2, values[i].n));
    i++;
    strcpy(temp1, values[i].str1);
    strcpy(temp2, values[i].str1);
    ck_assert_str_eq(memcpy(temp1, values[i].str2, values[i].n),
...
START_TEST(test_memmove) {
    ...
    strcpy(temp1, values[i].str1);
    strcpy(temp2, values[i].str1);
    ck_assert_str_eq(memmove(temp1, values[i].str2, values[i].n),
                     s21_memmove(temp2, values[i].str2, values[i].n));
    i++;
    strcpy(temp1, values[i].str1);
    strcpy(temp2, values[i].str1);
    ck_assert_str_eq(memmove(temp1, values[i].str2, values[i].n),
...
START_TEST(test_strncat) {
    ...
    strcpy(temp1, values[i].str1);
    strcpy(temp2, values[i].str1);
    ck_assert_str_eq(strncat(temp1, values[i].str2, values[i].n),
                     s21_strncat(temp2, values[i].str2, values[i].n));
    i++;
    strcpy(temp1, values[i].str1);
    strcpy(temp2, values[i].str1);
    ck_assert_str_eq(strncat(temp1, values[i].str2, values[i].n),
...
START_TEST(test_strncmp) {
    int i = 0;
    ck_assert_int_eq(strncmp(values[i].str1, values[i].str2, values[i].n),
                     s21_strncmp(values[i].str1, values[i].str2, values[i].n));
    i++;
    ck_assert_int_eq(strncmp(values[i].str1, values[i].str2, values[i].n),
                     s21_strncmp(values[i].str1, values[i].str2, values[i].n));
    i++;
...
START_TEST(test_strncpy) {
    ...
    strcpy(temp1, values[i].str1);
    strcpy(temp2, values[i].str1);
    ck_assert_str_eq(strncpy(temp1, values[i].str2, values[i].n),
                     s21_strncpy(temp2, values[i].str2, values[i].n));
    i++;
    strcpy(temp1, values[i].str1);
    strcpy(temp2, values[i].str1);
    ck_assert_str_eq(strncpy(temp1, values[i].str2, values[i].n),
