...
START_TEST(STRNCMPTest9) {
    char *test17 = "qweq1\0sdas";
    char *test18 = "\0sdas";
    ck_assert_msg(s21_strncmp(test17, test18, 10) == strncmp(test17, test18, 10), "Failed on 9");
}
...
START_TEST(STRNCMPTest10) {
    char *test13 = "1234";
    char *test14 = "\0 ";
    ck_assert_msg(s21_strncmp(test13, test14, 2) == strncmp(test13, test14 ,2), "Failed on 10");
}
...
START_TEST(STRNCMPTest11) {
    char *test19 = "    \0sdas";
    char *test20 = "  qweq";
    ck_assert_msg(s21_strncmp(test19, test20, 10) == strncmp(test19, test20, 10), "Failed on 11");
}
...
START_TEST(STRNCMPTest12) {
    ...
    char *test8 = "\0\n";
    ck_assert_msg(s21_strncmp(test7, test8, 3) == strncmp(test7, test8, 3), "Failed on 12");
}
...
START_TEST(STRNCMPTest13) {
    char *test7 = "#,$qwe%&";
    char *test8 = "#,4q@2";
    ck_assert_msg(s21_strncmp(test7, test8, 6) == strncmp(test7, test8, 6), "Failed on 14");
}
...
START_TEST(STRNCMPTest14) {
    char *test7 = "#,$qwe%&^\0q";
    char *test8 = "#,$\0";
    ck_assert_msg(s21_strncmp(test7, test8, 6) == strncmp(test7, test8, 6), "Failed on 15");
}
...
START_TEST(STRNCMPTest15) {
    char *test7 = "#,$qw/%&^\0\n";
    char *test8 = "#,\0q2qw";
    ck_assert_msg(s21_strncmp(test7, test8, 10) == strncmp(test7, test8, 10), "Failed on 16");
}
...
START_TEST(SPRINTF32) {
    char data[100];
    char data1[100];
    s21_sprintf(data, "|% -50.500000lf|\n", 10.10);
    sprintf(data1, "|% -50.500000lf|\n", 10.10);
    ck_assert_str_eq(data, data1);
}
...
Suite *f_example_suite_create() {
    ...
    TCase *StrnCmpTest = tcase_create("STRUMPET");
    ...
    tcase_add_test(StrnCmpTest, STRNCMPTest9);
    tcase_add_test(StrnCmpTest, STRNCMPTest10);
    tcase_add_test(StrnCmpTest, STRNCMPTest11);
    tcase_add_test(StrnCmpTest, STRNCMPTest12);
    tcase_add_test(StrnCmpTest, STRNCMPTest13);
    tcase_add_test(StrnCmpTest, STRNCMPTest14);
    tcase_add_test(StrnCmpTest, STRNCMPTest15);
