...
START_TEST(test_memcmp) {
    ...
    test a[N_TESTS] = {
        ...
        {"dit the sources so that the unit test compiles, we are actually ",
         "dit the sources so that the unit test compiles, we are actually ", '0'},
        {"", "", 1},
        {"", " ", 0},
        {" ", " ", 1},
        {" ", " ", 0},
...
START_TEST(test_strncpy) {
    ...
    test a[N_TESTS] = {
        ...
        {"get a whole host of compilation err",
         "get a whole host of compilation err", 'a'},
        {"ely write code that won", "ely write code that won", 1},
        {"dit the sources so that the unit test compiles, we are actually ",
         "dit the sources so that the unit test compiles, we are actually ", '0'},
        {"", "", 1},
...
// TODO(hl_lele): a[i].test_str == b' failed: a[i].test_str == "move",
//  b == "m1ov1e || failed: a[i].test_str == " uuuIIIuuu ", b == " uuu!III!uuu
